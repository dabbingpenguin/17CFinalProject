...
chess::Board::Board()
{
  ...
  legalMovesGraph = new Graph(64);
}

chess::Board::~Board() { delete legalMovesGraph; }
...
void chess::Board::merge(int arr[], int l, int m, int r)
{
    int n1 = m - l + 1;
    int n2 = r - m;
...
// of arr to be sorted */
// Taken from https://www.geeksforgeeks.org/merge-sort/
void chess::Board::mergeSort(int arr[],int l,int r)
{
