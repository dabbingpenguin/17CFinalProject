...
namespace chess
{
  ...
  class Board
  {
     private:
      ...
      void mergeSort(int arr[],int l,int r); // Taken from https://www.geeksforgeeks.org/merge-sort/
      void merge(int arr[], int l, int m, int r); // Taken from https://www.geeksforgeeks.org/merge-sort/

      void sortCapturedPieces();
